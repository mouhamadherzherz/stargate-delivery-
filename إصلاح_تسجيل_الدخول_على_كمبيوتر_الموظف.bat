...
echo ========================================================
echo.
echo يمكنك الآن الدخول بأي من الرموز التالية:
echo.
echo 1) عبر رمز PIN السريع (اضغط تبويب رمز PIN سريع):
echo    - رمز الإدارة:   19701313
echo    - أو الرمز:      20122020
echo    - أو رمز دعاء:   81097175
echo    - أو رمز آدم:    090921
echo    - أو رمز نور:    121314
echo.
echo 2) عبر اسم المستخدم وكلمة المرور:
